...
<h1 class="heading">ESCALATE TICKET</h1>
<div class="card p-5">
    ...
    <form action ={{route('admin-foward-ticket')}} method="post">
      ...
      <div class='form-group'>
        ...
        <input type="text" id="uniqueid" name="uniqueid" placeholder="Enter Ticket Number" value={{$selected ?? ''}}>

        <a class="btn btn-primary" href="{{route('admin-foward-search')}}">search</a>
      </div>
    ...
    <input type="text" name="subject" value="" id="subject" placeholder="Enter Subject" class="form-control">
    </div>
    <div class="form-group">
      <label for="notes">Explain the problem</label>
    ...
    <div class='form-group'>
      ...
      <input type="file" id="file" name="file" placeholder="Upload" class="form-control">
    </div>
